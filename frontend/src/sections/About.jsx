        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          >
            <div className="glass p-8 rounded-2xl relative overflow-hidden group">
              ...
              <h3 className="text-2xl font-semibold mb-4 text-slate-800 dark:text-slate-100">Professional Summary</h3>
          ...
          >
            <div className="glass p-6 rounded-2xl text-center hover:-translate-y-2 transition-transform duration-300 border border-transparent hover:border-primary/30">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">Years of Practice</p>
            </div>
            <div className="glass p-6 rounded-2xl text-center hover:-translate-y-2 transition-transform duration-300 border border-transparent hover:border-primary/30">
            ...
            <div className="glass p-6 rounded-2xl text-center hover:-translate-y-2 transition-transform duration-300 border border-transparent hover:border-primary/30">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">Dedication</p>
            </div>
          </motion.div>
        </div>
      </div>

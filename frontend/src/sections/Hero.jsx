...
const Hero = () => {
  return (
    <section 
      id="home"
      className="min-h-screen flex items-center justify-center pt-20 overflow-hidden relative  bg-slate-900"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex flex-col md:flex-row items-center justify-between">
        ...
        >
          <span className="text-primary font-medium tracking-wider uppercase mb-2">
            Hello, I'm
          </span>
          ...
          <h2 className="text-2xl md:text-3xl font-semibold text-slate-600 text-slate-300 mb-6">
            Web Developer
          </h2>
          <p className="text-lg text-gray-400 max-w-lg mb-8">
            Passionate about building responsive, user-friendly web
            applications. Adept at both front-end and back-end development,
            eager to contribute technical skills to a dynamic team.
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a
              href="/resume.pdf"
              target="_blank"
              className="px-8 py-3 rounded-full bg-gray-800 text-gray-50 font-medium hover:bg-slate-300 hover:bg-slate-700 transition-colors flex items-center gap-2"
            >

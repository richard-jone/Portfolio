      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative border-l-2 border-primary/30 pl-8 ml-4 md:ml-0 md:pl-0 md:border-none">
          ...
          >
            ...
            <div className="hidden md:flex absolute top-6 -left-3 w-6 h-6 bg-primary rounded-full items-center justify-center border-4 border-slate-50 border-slate-900 z-10 transform -translate-x-1/2"></div>
            
            {/* Mobile timeline dot */}
            <div className="md:hidden absolute top-6 -left-[2.35rem] w-4 h-4 bg-primary rounded-full items-center justify-center border-2 border-slate-50 border-slate-900 z-10"></div>
            ...
            <div className="glass p-6 rounded-2xl hover:-translate-y-2 transition-transform duration-300 relative group text-left">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-100">Computer Science and Engineering</h3>
              <h4 className="text-lg font-medium text-slate-600 text-slate-300 mb-4">Holy Cross Engineering College</h4>
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm font-medium">
                <span className="flex items-center gap-1 text-white-500 bg-slate-200 bg-slate-700 px-3 py-1 rounded-full">

...
const Skills = () => {
  return (
    <section id="skills" className="py-20 bg-slate-100/50 dark:bg-slate-800/50 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {skillCategories.map((category, idx) => (
            ...
            >
              <h3 className="text-xl font-semibold mb-6 text-slate-800 dark:text-slate-100 border-b border-slate-200 dark:border-slate-700 pb-2">
                {category.title}
              </h3>
